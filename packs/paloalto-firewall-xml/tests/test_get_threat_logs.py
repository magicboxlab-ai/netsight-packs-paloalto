"""Per-command tests for the ``get_threat_logs`` operation."""
...
OPERATION = "get_threat_logs"
EXPECTED_LOG_TYPE = "threat"


class TestGetThreatLogs:
    ...
    def test_sends_log_type_threat(
        self,
        client: PanOSXMLClient,
        run_operation: Callable[..., tuple[str, MagicMock]],
    ) -> None:
