"""Per-command tests for the ``show_running_security_policy`` operation."""
...
OPERATION = "show_running_security_policy"
EXPECTED_CMD = "<show><running><security-policy></security-policy></running></show>"


class TestShowRunningSecurityPolicy:
