"""Per-command tests for the ``show_bgp_rib`` operation."""
...
OPERATION = "show_bgp_rib"
EXPECTED_CMD = "<show><routing><protocol><bgp><loc-rib></loc-rib></bgp></protocol></routing></show>"


class TestShowBgpRib:
