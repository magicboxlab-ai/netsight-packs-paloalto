"""Per-command tests for ``request_logging_service_forwarding_status``."""
...
OPERATION = "request_logging_service_forwarding_status"
EXPECTED_CMD = (
    "<request><logging-service-forwarding><status></status>"
    "</logging-service-forwarding></request>"
)


class TestRequestLoggingServiceForwardingStatus:
