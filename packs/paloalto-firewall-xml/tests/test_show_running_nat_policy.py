"""Per-command tests for the ``show_running_nat_policy`` operation."""
...
OPERATION = "show_running_nat_policy"
EXPECTED_CMD = "<show><running><nat-policy></nat-policy></running></show>"


class TestShowRunningNatPolicy:
