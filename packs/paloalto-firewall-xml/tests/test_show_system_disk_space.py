"""Per-command tests for the ``show_system_disk_space`` operation."""
...
OPERATION = "show_system_disk_space"
EXPECTED_CMD = "<show><system><disk-space></disk-space></system></show>"


class TestShowSystemDiskSpace:
