"""Per-command tests for the ``show_ospf_neighbors`` operation."""
...
OPERATION = "show_ospf_neighbors"
EXPECTED_CMD = "<show><routing><protocol><ospf><neighbor></neighbor></ospf></protocol></routing></show>"
