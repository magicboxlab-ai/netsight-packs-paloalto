"""Per-command tests for the ``show_log_collectors`` operation."""
...
OPERATION = "show_log_collectors"
EXPECTED_CMD = "<show><log-collector><serial-number>all</serial-number></log-collector></show>"


class TestShowLogCollectors:
