"""Per-command tests for the ``show_dns_proxy_cache`` operation."""
...
OPERATION = "show_dns_proxy_cache"
EXPECTED_CMD = "<show><dns-proxy><cache><all/></cache></dns-proxy></show>"


class TestShowDnsProxyCache:
