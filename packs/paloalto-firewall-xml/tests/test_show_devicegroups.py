"""Per-command tests for the ``show_devicegroups`` operation."""
...
OPERATION = "show_devicegroups"
EXPECTED_CMD = "<show><devicegroups></devicegroups></show>"


class TestShowDevicegroups:
