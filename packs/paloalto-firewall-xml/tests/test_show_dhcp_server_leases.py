"""Per-command tests for the ``show_dhcp_server_leases`` operation."""
...
OPERATION = "show_dhcp_server_leases"
EXPECTED_CMD = "<show><dhcp><server><lease>all</lease></server></dhcp></show>"


class TestShowDhcpServerLeases:
