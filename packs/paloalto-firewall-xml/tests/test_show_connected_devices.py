"""Per-command tests for the ``show_connected_devices`` operation."""
...
OPERATION = "show_connected_devices"
EXPECTED_CMD = "<show><devices><connected></connected></devices></show>"


class TestShowConnectedDevices:
