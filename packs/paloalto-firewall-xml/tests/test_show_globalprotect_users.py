"""Per-command tests for the ``show_globalprotect_users`` operation."""
...
OPERATION = "show_globalprotect_users"
EXPECTED_CMD = "<show><global-protect-gateway><current-user></current-user></global-protect-gateway></show>"


class TestShowGlobalprotectUsers:
