"""Per-command tests for the ``get_globalprotect_logs`` operation."""
...
OPERATION = "get_globalprotect_logs"
EXPECTED_LOG_TYPE = "globalprotect"


class TestGetGlobalprotectLogs:
