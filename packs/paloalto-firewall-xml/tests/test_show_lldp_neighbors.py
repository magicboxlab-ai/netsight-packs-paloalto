"""Per-command tests for the ``show_lldp_neighbors`` operation."""
...
OPERATION = "show_lldp_neighbors"
EXPECTED_CMD = "<show><lldp><neighbors>all</neighbors></lldp></show>"


class TestShowLldpNeighbors:
