"""Per-command tests for the ``show_bfd_summary`` operation."""
...
OPERATION = "show_bfd_summary"
EXPECTED_CMD = "<show><routing><bfd><summary/></bfd></routing></show>"


class TestShowBfdSummary:
