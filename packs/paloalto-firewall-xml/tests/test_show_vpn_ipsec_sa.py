"""Per-command tests for the ``show_vpn_ipsec_sa`` operation."""
...
OPERATION = "show_vpn_ipsec_sa"
EXPECTED_CMD = "<show><vpn><ipsec-sa></ipsec-sa></vpn></show>"


class TestShowVpnIpsecSa:
