"""Per-command tests for the ``show_routing_summary`` operation."""
...
OPERATION = "show_routing_summary"
EXPECTED_CMD = "<show><routing><summary></summary></routing></show>"


class TestShowRoutingSummary:
