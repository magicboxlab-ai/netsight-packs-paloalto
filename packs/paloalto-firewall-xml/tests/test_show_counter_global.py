"""Per-command tests for the ``show_counter_global`` operation."""
...
OPERATION = "show_counter_global"
EXPECTED_CMD = "<show><counter><global><filter><delta>yes</delta></filter></global></counter></show>"


class TestShowCounterGlobal:
