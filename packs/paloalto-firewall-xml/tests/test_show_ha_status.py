"""Per-command tests for the ``show_ha_status`` operation."""
...
OPERATION = "show_ha_status"
EXPECTED_CMD = "<show><high-availability><all></all></high-availability></show>"


class TestShowHaStatus:
