"""Per-command tests for the ``show_counter_interface`` operation."""
...
OPERATION = "show_counter_interface"
EXPECTED_CMD = "<show><counter><interface>all</interface></counter></show>"


class TestShowCounterInterface:
